...
public class RainingCashWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(RainingCashWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/RainingFortunesWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/RainingFortunesWLAIW/InitOutcome.xml").getDocumentElement();
